...
### Objectives
<p>In this project, by using the Seattle Airbnb Data at 2016, I explore the features that might affect price. I also use the given information provided in an Airbnb listing to implement price suggestion model. My two key objectives are:</p>
